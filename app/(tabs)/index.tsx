...
const s = StyleSheet.create({
  ...
  logo: { fontSize: 24, fontWeight: '900', color: '#c9a84c', letterSpacing: 5 },
  screenTitle: { fontSize: 18, fontWeight: '900', color: '#e8e8f0', letterSpacing: 3 },
  backBtn: { fontSize: 14, color: '#c9a84c', width: 60, fontWeight: '600' },
  ...
  streakText: { color: '#c9a84c', fontSize: 13, fontWeight: '700' },
  ...
  coinDisplayText: { color: '#c9a84c', fontSize: 13, fontWeight: '700' },

  // Character card
  characterCard: { marginHorizontal: 16, marginTop: 4, backgroundColor: '#111118', borderWidth: 1, borderColor: 'rgba(201,168,76,0.15)', borderRadius: 24, padding: 20, shadowColor: '#c9a84c', shadowOpacity: 0.05, shadowRadius: 20, shadowOffset: { width: 0, height: 4 }, elevation: 4 },
  ...
  levelText: { fontSize: 11, fontWeight: '800', color: '#0a0a0f', letterSpacing: 0.5 },
  ...
  quickActionBtn: { flex: 1, backgroundColor: '#111118', borderWidth: 1, borderColor: '#1e1e2e', borderRadius: 16, paddingVertical: 14, paddingHorizontal: 8, alignItems: 'center', gap: 6 },
  quickActionText: { fontSize: 11, fontWeight: '700', color: '#666677', textTransform: 'uppercase', letterSpacing: 0.5 },

  // Sections
  section: { paddingHorizontal: 16, marginBottom: 20 },
  sectionTitle: { fontSize: 11, fontWeight: '700', color: '#555566', letterSpacing: 1.5, textTransform: 'uppercase', marginBottom: 12 },

  // Quest cards
  questCard: { backgroundColor: '#111118', borderWidth: 1, borderColor: '#1e1e2e', borderRadius: 16, padding: 14, marginBottom: 10, flexDirection: 'row', alignItems: 'center', gap: 14 },
  questDone: { borderColor: 'rgba(76,201,122,0.2)', backgroundColor: 'rgba(76,201,122,0.03)' },
  questName: { fontSize: 14, fontWeight: '700', color: '#e8e8f0', marginBottom: 3 },
  ...
  // Pills (supplement)
  pill: { backgroundColor: '#111118', borderWidth: 1, borderColor: '#1e1e2e', borderRadius: 20, paddingHorizontal: 14, paddingVertical: 7, marginRight: 8 },
  ...
  // Macro card
  macroCard: { backgroundColor: '#111118', borderWidth: 1, borderColor: '#1e1e2e', borderRadius: 18, padding: 16 },
  ...
  navLabel: { fontSize: 10, fontWeight: '600', color: '#444455', letterSpacing: 0.3 },
  navLabelActive: { color: '#c9a84c' },

  // Tabs
  tabRow: { paddingHorizontal: 16, marginBottom: 14 },
  tab: { paddingHorizontal: 18, paddingVertical: 9, marginRight: 8, backgroundColor: '#111118', borderWidth: 1, borderColor: '#1e1e2e', borderRadius: 22 },
  ...
  achievementCard: { backgroundColor: '#111118', borderWidth: 1, borderColor: '#1e1e2e', borderRadius: 18, padding: 16, flexDirection: 'row', alignItems: 'center', gap: 14, opacity: 0.5 },
  ...
  achievementName: { fontSize: 14, fontWeight: '700', color: '#e8e8f0', marginBottom: 3 },
  ...
  // Shop
  shopCard: { backgroundColor: '#111118', borderWidth: 1, borderColor: '#1e1e2e', borderRadius: 18, padding: 16, flexDirection: 'row', alignItems: 'center', gap: 14 },
  ...
  shopContent: { flex: 1 },
  shopItemName: { fontSize: 14, fontWeight: '700', color: '#e8e8f0', marginBottom: 2 },
  ...
  buyBtnDisabled: { backgroundColor: '#1e1e2e' },
  buyBtnText: { fontSize: 13, fontWeight: '800', color: '#0a0a0f' },
  ...
  // Nutrition
  summaryCard: { marginHorizontal: 16, backgroundColor: '#111118', borderWidth: 1, borderColor: '#1e1e2e', borderRadius: 22, padding: 20, marginBottom: 14 },
  mealTab: { paddingHorizontal: 18, paddingVertical: 10, marginRight: 8, backgroundColor: '#111118', borderWidth: 1, borderColor: '#1e1e2e', borderRadius: 14, alignItems: 'center' },
  ...
  loggedItem: { backgroundColor: '#111118', borderWidth: 1, borderColor: '#1e1e2e', borderRadius: 14, padding: 14, marginBottom: 8, flexDirection: 'row', alignItems: 'center' },
  searchBar: { flexDirection: 'row', alignItems: 'center', marginHorizontal: 16, marginBottom: 10, backgroundColor: '#111118', borderWidth: 1, borderColor: '#1e1e2e', borderRadius: 14, paddingHorizontal: 14 },
  searchInput: { flex: 1, paddingVertical: 14, fontSize: 15, color: '#e8e8f0' },
  ...
  foodResult: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: '#111118' },

  // Train
  quickStartBtn: { backgroundColor: '#111118', borderWidth: 1, borderColor: 'rgba(201,168,76,0.2)', borderRadius: 18, padding: 20, flexDirection: 'row', alignItems: 'center', gap: 16, marginBottom: 24 },
  quickStartTitle: { fontSize: 17, fontWeight: '800', color: '#e8e8f0', marginBottom: 3 },
  routineLabel: { fontSize: 11, fontWeight: '700', color: '#555566', letterSpacing: 1.5, textTransform: 'uppercase', marginBottom: 12 },
  routineCard: { backgroundColor: '#111118', borderWidth: 1, borderColor: '#1e1e2e', borderRadius: 16, padding: 18, marginBottom: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  routineName: { fontSize: 15, fontWeight: '700', color: '#e8e8f0', marginBottom: 4 },
  ...
  sessionTimer: { fontSize: 26, fontWeight: '800', color: '#e8e8f0' },
  ...
  restBar: { height: 40, backgroundColor: '#111118', borderBottomWidth: 1, borderBottomColor: '#1a1a28', justifyContent: 'center', overflow: 'hidden' },
  ...
  exerciseCard: { backgroundColor: '#111118', borderWidth: 1, borderColor: '#1e1e2e', borderRadius: 18, padding: 18, margin: 16, marginBottom: 0 },
  exerciseName: { fontSize: 17, fontWeight: '800', color: '#e8e8f0', flex: 1 },
  ...
  setInput: { flex: 1, backgroundColor: '#0d0d15', borderWidth: 1, borderColor: '#1e1e2e', borderRadius: 10, padding: 10, fontSize: 16, fontWeight: '700', color: '#e8e8f0', textAlign: 'center' },
  setInputDone: { borderColor: 'rgba(76,201,122,0.25)', backgroundColor: 'rgba(76,201,122,0.04)' },
  checkBtn: { width: 46, height: 42, borderRadius: 10, backgroundColor: '#0d0d15', borderWidth: 1, borderColor: '#1e1e2e', alignItems: 'center', justifyContent: 'center' },
  checkBtnDone: { backgroundColor: 'rgba(76,201,122,0.12)', borderColor: 'rgba(76,201,122,0.35)' },
  checkBtnText: { fontSize: 18, color: '#4cc97a' },
  addExerciseBtn: { margin: 16, padding: 16, borderWidth: 1.5, borderColor: '#1e1e2e', borderStyle: 'dashed', borderRadius: 14, alignItems: 'center' },
  ...
  finishText: { fontSize: 16, fontWeight: '900', color: '#0a0a0f', letterSpacing: 1 },

  // Modals
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.85)', justifyContent: 'flex-end' },
  modal: { backgroundColor: '#111118', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24, paddingBottom: 44, borderTopWidth: 1, borderColor: '#1e1e2e' },
  modalTitle: { fontSize: 18, fontWeight: '800', color: '#e8e8f0', marginBottom: 18, textAlign: 'center' },
  modalInput: { backgroundColor: '#0d0d15', borderWidth: 1, borderColor: '#1e1e2e', borderRadius: 12, padding: 16, fontSize: 15, color: '#e8e8f0', marginBottom: 14 },
  modalBtns: { flexDirection: 'row', gap: 10 },
  modalCancel: { flex: 1, padding: 16, backgroundColor: '#0d0d15', borderRadius: 12, alignItems: 'center', borderWidth: 1, borderColor: '#1e1e2e' },
  modalCancelText: { fontSize: 15, fontWeight: '700', color: '#555566' },
  modalSave: { flex: 1, padding: 16, backgroundColor: '#c9a84c', borderRadius: 12, alignItems: 'center' },
  modalSaveText: { fontSize: 15, fontWeight: '800', color: '#0a0a0f' },
});